...
export const createFoodEventItemSchema = foodEventItemSchema
  .omit({ id: true, foodEventId: true, normalizedName: true, createdAt: true })
  .partial({
    quantity: true,
    unit: true,
    caloriesEstimated: true,
    proteinGEstimated: true,
    carbsGEstimated: true,
    fatGEstimated: true,
